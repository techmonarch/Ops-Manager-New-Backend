namespace OpsManagerAPI.WebApi.Configurations;
...
internal static class Startup
{
    internal static WebApplicationBuilder AddConfigurations(this WebApplicationBuilder builder)
    {
        ...
        builder.Configuration.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/firebase.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/firebase.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
