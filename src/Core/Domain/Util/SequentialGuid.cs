...
public sealed class SequentialGuid
{
    ...
    /// </summary>
    public static SequentialGuid SqlServer { get; set; } = new SequentialGuid(SequentialGuidDatabaseType.SqlServer);
    public static SequentialGuid PostgreSql { get; set; } = new SequentialGuid(SequentialGuidDatabaseType.PostgreSql);
    public static SequentialGuid MySql { get; set; } = new SequentialGuid(SequentialGuidDatabaseType.MySql);
    public static SequentialGuid Oracle { get; set; } = new SequentialGuid(SequentialGuidDatabaseType.Oracle);
    ...
    /// </summary>
    private SequentialGuid(SequentialGuidDatabaseType serverTye)
    {
        DatabaseType = serverTye;
    }

    public DefaultIdType NewGuid()
    {
        return Create(DatabaseType);
    }

    private static DefaultIdType Create(SequentialGuidDatabaseType databaseType)
    {
    ...
    private static DefaultIdType Create(SequentialGuidType guidType)
    {
        ...
        return new DefaultIdType(guidBytes);
    }
    ...
    public enum SequentialGuidType
    {
        ...
        /// <see cref="DefaultIdType.ToString()" /> method.
        /// </summary>
        SequentialAsString,

        /// <summary>
        /// The GUID should be sequential when formatted using the
        /// <see cref="DefaultIdType.ToByteArray" /> method.
        /// </summary>
        SequentialAsBinary,
